      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-lg z-[60] bg-background border border-border rounded-2xl overflow-hidden flex flex-col max-h-[90vh]"
          >
